					...
					if ((jsonData.meta.records <= 0)){
						...
						for (let i = 0; i < keys.length; i++){
							...
							for (let j = 0; j < gameList.length; j++){
								...
								gameString += '<div class="mapLine"><div class="mapPreview"><img src="'+gameList[j].preview+'" alt="preview" style="width:96px;height:96px;"></div><div class="map"><p class="mapName"><span class=" color-'+(i%9)+'">'+(j+1)+'.</span> '+gameList[j].mapName+'</p><span class="mapPlayCount">(played <b>'+gameList[j].played	+'</b> times)<br>(represents <b>'+percent+'</b>% of games analyzed)</span></div></div>';
							}
